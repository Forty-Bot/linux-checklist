...
1. Secure Users
	...
	1. Enforce  Password Requirements.
		1. **IMPORTANT** Change all passwords to satisfy the rules below, If you don't you will NOT be able to login. (One uppercase, one lowercase, one symbol and one number, atleast 8 chars)
